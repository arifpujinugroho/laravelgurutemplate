                        ...
                        <div class="checkbox-fade fade-in-primary d-block">
                            <label class="check-task d-block">
                                ...
                                <span class="task-card-img m-l-40 d-block">
                                    <a href="#!"><img src="{{url('assets/images/avatar-2.jpg')}}" data-toggle="tooltip" title="Lary Doe" alt="" class="img-40"></a>
                                    <a href="#!"><img src="{{url('assets/images/avatar-3.jpg')}}" data-toggle="tooltip" title="Alia" alt="" class="img-40 m-l-10"></a>
                                </span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="to-do-list">
                        <div class="checkbox-fade fade-in-primary d-block">
                            <label class="check-task d-block">
                                ...
                                <span class="task-card-img m-l-40 d-block">
                                    <a href="#!"><img src="{{url('assets/images/avatar-2.jpg')}}" data-toggle="tooltip" title="Alia" alt="" class="img-40"></a>
                                    <a href="#!"><img src="{{url('assets/images/avatar-3.jpg')}}" data-toggle="tooltip" title="Suzen" alt="" class="img-40 m-l-10"></a>
                                    <a href="#!"><img src="{{url('assets/images/avatar-4.jpg')}}" data-toggle="tooltip" title="Lary Doe" alt="" class="img-40 m-l-10"></a>
                                    <a href="#!"><img src="{{url('assets/images/avatar-2.jpg')}}" data-toggle="tooltip" title="Josephin Doe" alt="" class="img-40 m-l-10"></a>
                                </span>
                            </label>
                        </div>
                    </div>
                ...
                <div class="card-block ">
                    <div class="card-contain text-center ">
                        ...
                        <div class="contain-card p-t-30 p-b-10 ">
                            <a href="#!"><img src="{{url('assets/images/avatar-4.jpg')}}" data-toggle="tooltip" title="Alia" alt="" class="img-40"></a>
                            <a href="#!"><img src="{{url('assets/images/avatar-3.jpg')}}" data-toggle="tooltip" title="Suzen" alt="" class="img-40 m-l-5"></a>
                            <a href="#!"><img src="{{url('assets/images/avatar-4.jpg')}}" data-toggle="tooltip" title="Lary Doe" alt="" class="img-40 m-l-5"></a>
                            <a href="#!"><img src="{{url('assets/images/avatar-2.jpg')}}" data-toggle="tooltip" title="Josephin Doe" alt="" class="img-40 m-l-5"></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="card ">
                ...
                <div class="card-block p-0">
                    <div class="card-comment ">
                        <div class="card-block-small">
                            <img class="img-radius img-50" src="{{url('assets/images/avatar-4.jpg')}}" alt="user-1">
                    ...
                    <div class="card-comment ">
                        <div class="card-block-small">
                            <img class="img-radius img-50" src="{{url('assets/images/avatar-3.jpg')}}" alt="user-4">
                            <div class="comment-desc">
                                <h6>John Doe</h6>
                                <p class="text-muted ">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text.</p>
                                <div class="comment-btn">
                    ...
                    <div class="card-comment ">
                        <div class="card-block-small">
                            <img class="img-radius img-50" src="{{url('assets/images/avatar-4.jpg')}}" alt="user-2">
                            <div class="comment-desc">
                                <h6>Planner Board</h6>
                                <p class="text-muted ">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text.</p>
                                <div class="comment-btn">
                    ...
                    <div class="card-comment ">
                        <div class="card-block-small">
                            <img class="img-radius img-50" src="{{url('assets/images/avatar-2.jpg')}}" alt="user-3">
                            <div class="comment-desc">
                                <h6>Luciano Durk</h6>
                                <p class="text-muted ">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text.</p>
                                <div class="comment-btn">
