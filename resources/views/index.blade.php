...
<html lang="en">
  <head>
	...
	<!-- Favicon icon -->
	<link rel="icon" href="{{url('assets/landingpage/assets/logos/favicon.ico')}}" type="image/png" sizes="16x16">
	<!-- Bootstrap -->
    <link href="{{url('assets/landingpage/assets/css/bootstrap.min.css')}}" rel="stylesheet" type="text/css" media="all" />
	<!-- Font -->
	<link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,700" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Poppins:400,300,500,700,600" rel="stylesheet" type="text/css">
	<!-- Animate CSS -->
    <link rel="stylesheet" href="{{url('assets/landingpage/assets/css/animate.css')}}">
	<!-- Owl Carousel -->
    <link rel="stylesheet" href="{{url('assets/landingpage/assets/css/owl.carousel.css')}}">
    <link rel="stylesheet" href="{{url('assets/landingpage/assets/css/owl.theme.css')}}">
	<!-- Magnific Popup -->
    <link rel="stylesheet" href="{{url('assets/landingpage/assets/css/magnific-popup.css')}}">
	<!-- Full Page Animation -->
    <link rel="stylesheet" href="{{url('assets/landingpage/assets/css/animsition.min.css')}}">
	<!-- Ionic Icons -->
    <link rel="stylesheet" href="{{url('assets/landingpage/assets/css/ionicons.min.css')}}"> 
	<!-- Main Style css -->
    <link href="{{url('assets/landingpage/assets/css/style.css')}}" rel="stylesheet" type="text/css" media="all" />
  </head>
  <body>
        ...
        <div class="container">
          ...
          <div class="navbar-header page-scroll">
            <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
              ...
              <a class="navbar-brand page-scroll" href="#main"><img src="{{url('assets/landingpage/assets/logos/logo.png')}}" alt="Guru Able Logo" /></a>
              </div>
              ...
              <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li><a class="page-scroll" href="#subscribe">Contact</a></li>
                </ul>
            </div>
          </div>
        </nav><!-- /.navbar-collapse -->
        ...
        <div class="container">
          <div class="hero-content app-hero-content text-center">
            <div class="col-md-10 col-md-offset-1 nopadding">
                ...
                <a class="btn btn-primary btn-action" data-wow-delay="0.2s" href="{{url('/dashboard/default')}}">Live Preview</a>
				{{--<a class="btn btn-primary btn-action" data-wow-delay="0.2s" href="#">Buy Now</a>--}}
            </div>
          <div class="col-md-12">
            <div class="hero-image">
              <img class="img-responsive" src="{{url('assets/landingpage/assets/images/app_hero_1.png')}}" alt="" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="services-section text-center" id="services"><!-- Services section (small) with icons -->
        <div class="container">
          ...
          <div class="services-content">
            ...
            <p class="wow fadeInUp" data-wow-delay="0.2s">
              Guru Able is one of the finest Admin dashboard template in its category. Premium admin dashboard with high end feature rich possibilities.
            </p>
          </div>
        </div>
          ...
          <div class="services">
            <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.2s">
              <div class="services-icon">
                <img src="{{url('assets/landingpage/assets/logos/icon1.png')}}" height="60" width="60" alt="Service" />
              </div>
              <div class="services-description">
                <h1>Mega feature rich</h1>
                <p>
                  Guru Able is one of unique dashboard template which come with tons of ready to use feature. We continuous working on it to provide latest updates in digital market.
                </p>
              </div>
            </div>
            <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.3s">
              <div class="services-icon">
                <img class="icon-2" src="{{url('assets/landingpage/assets/logos/icon2.png')}}" height="60" width="60" alt="Service" />
              </div>
              <div class="services-description">
                <h1>Fast and Robust</h1>
                <p>
                  We are contantly working on Guru Able and improve its performance too. Your definitely give higher rating to Guru Able for its performance.
                </p>
              </div>
            </div>
            <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.4s">
              <div class="services-icon">
                <img class="icon-3" src="{{url('assets/landingpage/assets/logos/icon3.png')}}" height="60" width="60" alt="Service" />
              </div>
              <div class="services-description">
                <h1>FLAT UI-Interface</h1>
                <p>
                  Guru able is first ever admin dashboard template which release in Bootstrap 4 framework. Intuitive feature rich design concept and color combination.
                </p>
              </div>
            </div>
          </div>
  ...
  <div class="flex-features" id="features">
      ...
      <div class="flex-split"><!-- Feature section with flex layout -->
        <div class="f-left wow fadeInUp" data-wow-delay="0s">
          <div class="left-content">
            <img class="img-responsive" src="{{url('assets/landingpage/assets/images/feature_1.png')}}" alt="" />
          </div>
        </div>
      ...
      <div class="flex-split"><!-- Feature section with flex layout -->
        ...
        <div class="f-left">
          <div class="left-content wow fadeInUp" data-wow-delay="0.3s">
            <img class="img-responsive" src="{{url('assets/landingpage/assets/images/feature_2.png')}}" alt="" />
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row text-center">
          ...
          <!--  <h1>Destiny is loved by many Startups.</h1>
            ...
            <div class="testimonials owl-carousel owl-theme">
              <div class="testimonial-single"><img class="img-circle" src="{{url('assets/landingpage/assets/images/testimonial2.jpg')}}" alt="Client Testimonoal" />
              ...
              <div class="testimonial-single"><img class="img-circle" src="{{url('assets/landingpage/assets/images/testimonial1.jpg')}}" alt="Client Testimonoal" />
              ...
              <div class="testimonial-single"><img class="img-circle" src="{{url('assets/landingpage/assets/images/testimonial3.jpg')}}" alt="Client Testimonoal" />
                <div class="testimonial-text">
    ...
    <!-- Feature Image Big -->
      <div class="feature_huge text-center">
        <div class="container nopadding">
          <div class="col-md-12">
            <img class="img-responsive wow fadeInUp" data-wow-delay="0.1s" src="{{url('assets/landingpage/assets/images/big_feature.png')}}" alt="" style="max-width:100%"/>
          </div>
          <div class="feature_list">
            <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.2s">
              <img src="{{url('assets/landingpage/assets/logos/feature_icon.png')}}" alt="Feature" />
            ...
            <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.4s">
              <img src="{{url('assets/landingpage/assets/logos/feature_icon_2.png')}}" alt="Feature" />
            ...
            <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.6s">
              <img src="{{url('assets/landingpage/assets/logos/feature_icon_3.png')}}" alt="Feature" />
        ...
        <div class="col-md-12 col-sm-12 nopadding">
          ...
          <div class="col-sm-6 nopadding">
            <div class="table-left wow fadeInUp" data-wow-delay="0.4s">
              <div class="icon">
                <img src="{{url('assets/landingpage/assets/logos/cart2.png')}}" alt="Icon" />
              </div>
          ...
          <div class="col-sm-6 nopadding">
            <div class="table-right wow fadeInUp" data-wow-delay="0.6s">
              <div class="icon">
                <img src="{{url('assets/landingpage/assets/logos/cart1.png')}}" alt="Icon" />
              </div>
              <div class="pricing-details">
                <h2>Premium Plan</h2>
                <span>$19.99</span>
  ...
  <div class="client-section">
    <div class="container text-center">
      <div class="clients owl-carousel owl-theme">
        <div class="single">
          <img src="{{url('assets/landingpage/assets/logos/logo1.png')}}" alt="" />
        </div>
        <div class="single">
          <img src="{{url('assets/landingpage/assets/logos/logo2.png')}}" alt="" />
        </div>
        <div class="single">
          <img src="{{url('assets/landingpage/assets/logos/logo3.png')}}" alt="" />
        </div>
        <div class="single">
          <img src="{{url('assets/landingpage/assets/logos/logo4.png')}}" alt="" />
        </div>
        <div class="single">
          <img src="{{url('assets/landingpage/assets/logos/logo6.png')}}" alt="" />
        </div>
        <div class="single">
          <img src="{{url('assets/landingpage/assets/logos/logo7.png')}}" alt="" />
        </div>
      </div>
    </div>
  </div>
...
<!-- Subscribe Form -->
  <div class="cta-sub text-center no-color" id="subscribe">
    <div class="container">
      ...
      <div class="form wow fadeInUp" data-wow-delay="0.3s">
        <form class="subscribe-form wow zoomIn" action="{{url('assets/landingpage/assets/php/subscribe.php')}}" method="post" accept-charset="UTF-8" enctype="application/x-www-form-urlencoded" autocomplete="off" novalidate>
...
<!-- Footer Section -->
  <div class="footer">
    <div class="container">
        <div class="col-md-12 text-center">
          <img src="{{url('assets/landingpage/assets/logos/logo.png')}}" alt="Guru Able Logo" />
        ...
        <div class="footer-text">
          <p>
            Copyright © {{ date('Y') }} Guru Able. All Rights Reserved.
          </p>
        </div>
      </div>
      </div>
...
<!-- Jquery and Js Plugins -->
  <script type="text/javascript" src="{{url('assets/landingpage/assets/js/jquery-2.1.1.js')}}"></script>
  <script type="text/javascript" src="{{url('assets/landingpage/assets/js/bootstrap.min.js')}}"></script>
  <script type="text/javascript" src="{{url('assets/landingpage/assets/js/plugins.js')}}"></script>
  <script type="text/javascript" src="{{url('assets/landingpage/assets/js/menu.js')}}"></script>
  <script type="text/javascript" src="{{url('assets/landingpage/assets/js/custom.js')}}"></script>
  </body>
</html>
